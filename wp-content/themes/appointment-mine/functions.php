<?php
add_action( 'wp_enqueue_scripts', 'appointment_mine_theme_css',999);
function appointment_mine_theme_css() {
...
/*
	 ...
	 */
	function appointment_mine_setup() {
   add_theme_support( 'title-tag' );
}
add_action( 'after_setup_theme', 'appointment_mine_setup' );
?>