...
<head>
	...
	<link rel="shortcut icon" href="<?php  echo $header_setting['../appointment/upload_image_favicon']; ?>" /> 
	<?php } ?>
	...
	<div class="container">
		...
		<div class="navbar-header">
				...
				<?php
					...
					{ ?>
					<img class="img-responsive" src="<?php echo $header_setting['../appointment/upload_image_logo']; ?>" style="height:<?php echo $header_setting['height']; ?>px; width:<?php echo $header_setting['width']; ?>px;"/>
					<?php } else { ?>
