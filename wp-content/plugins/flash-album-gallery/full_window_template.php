...
<div id="page" class="flagallery-wrapper">
    <?php if(!isset($_GET['iframe'])){
        ...
        $backlink = isset($flag_custom["mb_bg_link"][0]) && !empty($flag_custom["mb_bg_link"][0])? $flag_custom['mb_bg_link'][0] : '';
        ...
        <div class="flagallery-header">
            <div class="flagallery-menu">
                ...
                <div class="flagallery-menu-items">
                    <a href="<?php echo $home_url; ?>" class="btn btn-homepage" title="<?php esc_attr_e(get_bloginfo('name')); ?>"><i class="fa fa-home"><span><?php _e('Home', 'flash-album-gallery') ?></span></i></a>
